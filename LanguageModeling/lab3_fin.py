...
things_to_ask = [ f"<question>Mikä on aasi?<context>",
    f"<question>Kun kultakaupunki tuhoutui?<context>",
    f"<question>Kuinka vanha Marry on?<context>",
    f"<question>Miksi King on niin tyhmä?<context>", ]
...
for epoch in range(epochs):
    ...
    model.save_pretrained("best_fin_model_GPT2_window_data_all_data")
